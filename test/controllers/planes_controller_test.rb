...
class PlanesControllerTest < ActionController::TestCase
  ...
  test "should create plane" do
    assert_difference('Plane.count') do
      post :create, plane: { ac_reg: @plane.ac_reg, ac_typ: @plane.ac_typ, body: @plane.body, group: @plane.group, note: @plane.note, operator: @plane.operator, ph_out: @plane.ph_out }
    end
  ...
  test "should update plane" do
    patch :update, id: @plane, plane: { ac_reg: @plane.ac_reg, ac_typ: @plane.ac_typ, body: @plane.body, group: @plane.group, note: @plane.note, operator: @plane.operator, ph_out: @plane.ph_out }
    assert_redirected_to plane_path(assigns(:plane))
  end
